...
func AccountfailedwebhooksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/account.failed_webhooks.json%s", cfg.BaseURL, queryString)
...
func CreateAccountfailedwebhooksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_account_failed_webhooks_json",
		mcp.WithDescription("List webhooks that was not delivered to the callback."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AccountfailedwebhooksHandler(cfg),
	}
}
