...
func BasketliveshippingservicelistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/basket.live_shipping_service.list.json%s", cfg.BaseURL, queryString)
...
func CreateBasketliveshippingservicelistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_basket_live_shipping_service_list_json",
		mcp.WithDescription("Retrieve a list of live shipping rate services."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    BasketliveshippingservicelistHandler(cfg),
	}
}
