...
func BasketinfoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/basket.info.json%s", cfg.BaseURL, queryString)
...
func CreateBasketinfoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_basket_info_json",
		mcp.WithDescription("Retrieve basket information."),
