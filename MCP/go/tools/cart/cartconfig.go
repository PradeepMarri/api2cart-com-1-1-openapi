...
func CartconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.config.json%s", cfg.BaseURL, queryString)
...
func CreateCartconfigTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_config_json",
		mcp.WithDescription("Get list of cart configs"),
