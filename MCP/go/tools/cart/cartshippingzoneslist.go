...
func CartshippingzoneslistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.shipping_zones.list.json%s", cfg.BaseURL, queryString)
...
func CreateCartshippingzoneslistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_shipping_zones_list_json",
		mcp.WithDescription("Get list of shipping zones"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartshippingzoneslistHandler(cfg),
	}
}
