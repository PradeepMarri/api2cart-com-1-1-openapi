...
func CartmetadataunsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.meta_data.unset.json%s", cfg.BaseURL, queryString)
...
func CreateCartmetadataunsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_cart_meta_data_unset_json",
		mcp.WithDescription("Unset meta data for a specific entity"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartmetadataunsetHandler(cfg),
	}
}
