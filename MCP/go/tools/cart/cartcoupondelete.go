...
func CartcoupondeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.coupon.delete.json%s", cfg.BaseURL, queryString)
...
func CreateCartcoupondeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_cart_coupon_delete_json",
		mcp.WithDescription("Delete coupon"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartcoupondeleteHandler(cfg),
	}
}
