...
func CartgiftcardlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.giftcard.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseCartGiftCardList
...
func CreateCartgiftcardlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_giftcard_list_json",
		mcp.WithDescription("Get gift cards list."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartgiftcardlistHandler(cfg),
	}
}
