...
func CartmetadatalistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.meta_data.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseCartMetaDataList
...
func CreateCartmetadatalistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_meta_data_list_json",
		mcp.WithDescription("Get entity meta data"),
		...
		mcp.WithString("key", mcp.Description("Key")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartmetadatalistHandler(cfg),
	}
}
