...
func CartcatalogpriceruleslistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.catalog_price_rules.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseCartCatalogPriceRulesList
...
func CreateCartcatalogpriceruleslistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_catalog_price_rules_list_json",
		mcp.WithDescription("Get cart catalog price rules discounts."),
		...
		mcp.WithString("ids", mcp.Description("Retrieves  catalog_price_rules by ids")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CartcatalogpriceruleslistHandler(cfg),
	}
}
