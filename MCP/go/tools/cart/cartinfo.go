...
func CartinfoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cart.info.json%s", cfg.BaseURL, queryString)
...
func CreateCartinfoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cart_info_json",
		mcp.WithDescription("Get cart information"),
