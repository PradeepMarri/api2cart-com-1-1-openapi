...
func CategoryinfoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/category.info.json%s", cfg.BaseURL, queryString)
...
func CreateCategoryinfoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_category_info_json",
		mcp.WithDescription("Get category info about category ID*** or specify other category ID."),
		mcp.WithString("id", mcp.Required(), mcp.Description("Retrieves category's info specified by category id")),
		...
		mcp.WithString("store_id", mcp.Description("Retrieves category info  specified by store id")),
		mcp.WithString("lang_id", mcp.Description("Retrieves category info  specified by language id")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CategoryinfoHandler(cfg),
	}
}
