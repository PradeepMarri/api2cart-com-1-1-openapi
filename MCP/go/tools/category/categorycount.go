...
func CategorycountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/category.count.json%s", cfg.BaseURL, queryString)
...
func CreateCategorycountTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_category_count_json",
		mcp.WithDescription("Count categories in store."),
		mcp.WithString("parent_id", mcp.Description("Counts categories specified by parent id")),
		mcp.WithString("store_id", mcp.Description("Counts category specified by store id")),
		mcp.WithString("lang_id", mcp.Description("Counts category specified by language id")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CategorycountHandler(cfg),
	}
}
