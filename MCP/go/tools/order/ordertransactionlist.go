...
func OrdertransactionlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/order.transaction.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseOrderTransactionList
...
func CreateOrdertransactionlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_order_transaction_list_json",
		mcp.WithDescription("Retrieve list of order transaction"),
		...
		mcp.WithString("order_ids", mcp.Required(), mcp.Description("Retrieves order transactions specified by order ids")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertransactionlistHandler(cfg),
	}
}
