...
func OrdershipmentinfoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/order.shipment.info.json%s", cfg.BaseURL, queryString)
...
func CreateOrdershipmentinfoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_order_shipment_info_json",
		mcp.WithDescription("Get information of shipment."),
		mcp.WithString("id", mcp.Required(), mcp.Description("Entity id")),
		mcp.WithString("order_id", mcp.Required(), mcp.Description("Defines the order id")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdershipmentinfoHandler(cfg),
	}
}
