...
func OrderfindHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/order.find.json%s", cfg.BaseURL, queryString)
...
func CreateOrderfindTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_order_find_json",
		mcp.WithDescription("This method is deprecated and won't be supported in the future. Please use "order.list" instead."),
