...
func OrdershipmentlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/order.shipment.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseOrderShipmentList
...
func CreateOrdershipmentlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_order_shipment_list_json",
		mcp.WithDescription("Get list of shipments by orders."),
		mcp.WithString("order_id", mcp.Required(), mcp.Description("Retrieves shipments specified by order id")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdershipmentlistHandler(cfg),
	}
}
