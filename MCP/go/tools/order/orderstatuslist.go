...
func OrderstatuslistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/order.status.list.json%s", cfg.BaseURL, queryString)
...
func CreateOrderstatuslistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_order_status_list_json",
		mcp.WithDescription("Retrieve list of statuses"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrderstatuslistHandler(cfg),
	}
}
