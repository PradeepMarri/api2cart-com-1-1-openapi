...
func AttributeattributesetlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/attribute.attributeset.list.json%s", cfg.BaseURL, queryString)
...
func CreateAttributeattributesetlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_attribute_attributeset_list_json",
		mcp.WithDescription("Get attribute_set list"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AttributeattributesetlistHandler(cfg),
	}
}
