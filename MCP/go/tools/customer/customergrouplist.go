...
func CustomergrouplistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/customer.group.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseCustomerGroupList
...
func CreateCustomergrouplistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_customer_group_list_json",
		mcp.WithDescription("Get list of customers groups."),
		...
		mcp.WithString("group_ids", mcp.Description("Groups that will be assigned to a customer")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CustomergrouplistHandler(cfg),
	}
}
