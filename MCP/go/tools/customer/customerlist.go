...
func CustomerlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/customer.list.json%s", cfg.BaseURL, queryString)
		...
		var result models.ModelResponseCustomerList
...
func CreateCustomerlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_customer_list_json",
		mcp.WithDescription("Get list of customers from store."),
		...
		mcp.WithString("store_id", mcp.Description("Retrieves customers specified by store id")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CustomerlistHandler(cfg),
	}
}
